...
| ------------------- | --------------------------------- | -------------------------------- | ----------------------------------------- | ------------------------------------- |
| **Purpose**         | Identity for individuals or apps  | Organize users                   | Temporary permission for AWS services/users | Defines permissions                   |
| **Credentials**     | Long-term (password, access keys) | Inherited from group policies    | Temporary credentials                     | Not applicable                        |
| **Attach Policies** | ✅ Yes                             | ✅ Yes                            | ✅ Yes                                     | N/A (policies are attached to others) |
| **Best For**        | Human access, CLI/API             | Managing multiple users together | EC2, Lambda, cross-account                | Reusable permission sets              |
